...
1. Details on how to use this repository and how to prepare for the report are located in the `isbe_midyear_report_documentation.Rmd` file. You must knit the file to PDF in order to see the photos.  
