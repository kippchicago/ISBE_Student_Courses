...
CPS will send detailed documentation on what is required for the report to whoever is designated as the "data liason". \textcolor{red}{Once you find out what pieces of information you need, it is important to begin collecting data as soon as possible.} You may need to collect information from the COO, Chief of Staff, Talent Department and HR, so you need to put in your requests early. For more information on required data read section 3, "Data Sources and how to access them". Note: Some data requirements may change from year to year. 
